...
Где tamplate определяет создание шаблона typename имя шаблонного типа.
T - это шаблонный тип данных.
После создания шаблона любой принимаемый параметр функции и любая локальная переменная функции
может быть шаблонного типа. Созданный шаблон существует лишь до точки с запятой после прототипа
