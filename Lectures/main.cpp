...
* Тернарный оператор возвращает одно из двух значений, в зависимости от условия.
* Если условие true - тернарный оператор возвращает value1;
* Если условие false - тернарный оператор возвращает value2;
